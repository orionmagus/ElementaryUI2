...
const elevation_colors = {
  umbra: "rgba(0,0,0,0.3)",
  penumbra: "rgba(0,0,0,0.9)",
  ambient: "rgba(150,150,150,0.1)"
};
// helper to generate box shadow setting
const addDepth = (type, z) => css`
  ${props => `${depth[type][z]} ${props.theme.elevation && type in props.theme.elevation ? props.theme.elevation[type] : elevation_colors[type]}`}
`;
// const addDepth = (type, z) => css`
//   ${props => `${depth[type][z]} ${props.theme.elevation.colors[type]}`}
// `;
export default z => css`
