import { LOCATION_CHANGE } from "./middleware";

const defaultSelectLocationState = state => state.routing;

export default function syncHistoryWithStore(history, store, { selectLocationState = defaultSelectLocationState, adjustUrlOnReplay = true } = {}) {
